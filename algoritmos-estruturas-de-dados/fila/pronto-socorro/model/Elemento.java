...
public final class Elemento<T> {
    ...
    private Elemento<T> proximo; //Referencia ao endereco dos Elemento anterior e proximo, que antecede e sucede, respectivamente, na lista o Elemento.this de valor T dado
